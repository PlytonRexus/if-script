...
const grammar = {
  ...
  ParserRules: [
    ...
    {
      name: 'section',
      symbols: ['section$string$1', '_', 'section$subexpression$1', '_', 'section$string$2', '_', 'oneline', '_', 'section$string$3', '_', 'text', '_', 'section$ebnf$1', '_', 'section$string$4'],
      postprocess:
      function (d) {
        /*
    ...
    {
      name: 'choice',
      symbols: ['choice$string$1', '_', 'choice$subexpression$1', '_', 'oneline', '__', 'choice$subexpression$2', '_', 'choice$ebnf$1', '_', 'choice$ebnf$2', '_', 'choice$subexpression$3', '_', 'choice$string$2', '_'],
      postprocess:
      /**
      ...
      */
      function (d) {
        const conditionArray = d[2][0] ? d[2][0] : null
        const condition = conditionArray ? {} : null
        ...
        const text = d[4]
        const mode = d[6][0] === '__input' ? 'input' : 'basic'
