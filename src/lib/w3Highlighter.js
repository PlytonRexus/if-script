export default function w3CodeColor(elmnt, mode) {
  var lang = mode || 'html'
  var elmntObj =
    typeof elmnt === 'string' ? document.getElementById(elmnt) : elmnt
  ...
  function cssPropertyValueMode(txt) {
    var rest = txt,
      ...
      s
    rest =
      '<span style=color:' + cssdelimitercolor + '>:</span>' + rest.substring(1)
